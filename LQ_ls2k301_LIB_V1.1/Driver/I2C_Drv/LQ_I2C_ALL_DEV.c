...
static int __init dev_init(void)
{
    ...
    // 复制设备名称
    strlcpy(IIC_Equipment.type, DEVICE_ID_NAME, I2C_NAME_SIZE);
    ...
    printk("LQ_I2C_ALL_DEV init function\n");
