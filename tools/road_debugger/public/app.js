...
const PARAMETER_LABELS = {
  ...
  gyro_dps: '实际角速度',
  y_guard_active: '瞄点越界救车状态',
  y_guard_aim_dy_px: '瞄点相对车体Y',
  y_guard_target_dps: '救车目标角速度',
  gyro_timeout: '陀螺仪超时数',
...
const TUNING_GROUPS = [
  ...
  },
  {
    ...
    controls: [
      ...
      { key: 'dbBrakePwm', label: '主动制动反向PWM', min: 0, max: 9000, step: 50, defaultValue: 9000, hardMax: true },
...
const TUNING_DESCRIPTIONS = Object.freeze({
  ...
  dbHTol: '三阶段航向控制进入静默区的角度阈值，单位deg，退出阈值为该值+1deg。车头积分达到或越过阶段目标角时可直接切换；本参数主要影响接近目标时何时停止修正，并保留稳定但未越线时的兜底切换。',
